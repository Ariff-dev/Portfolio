...
export const Hero = () => {
  return (
    <section
      id='hero'
      className='flex items-center flex-col min-h-screen  justify-center-safe gap-6'
    >
      <div className='flex justify-center items-center flex-col gap-2'>
        <img
          className='rounded-2xl w-1/2 bg-(--primary) p-1'
          src={Photo}
          alt='Ariff Martinez Photho'
        />
        <h1 className='text-2xl '>Ariff Martinez</h1>
        <p className='text-prtimary text-(--secondary) text-lg text-center'>
          Software Developer & Analyst
          <span className='block text-(--primary)'>Financial Technology</span>
        </p>
        <p className=''>
